...
void CAT(get_nb_energy, SUFFIX)(nb_energy_arg_t *arg)
{
  ...
  doublev4 c0_v4 = 0.0, c2_v4 = 2.0, c1_v4 = 1.0, c6_v4 = 6.0, c12_v4 = 12.0;
  accum.eedvir = c0_v4;
  accum.eed    = c0_v4;
  accum.evdw   = c0_v4;
  accum.ehb    = c0_v4;
  ...
  doublev4 max_nb_cut2_v4  = max_nb_cut2;
  ...
  for (icit = pe_bkt_lo; icit < pe_bkt_hi; icit ++){
    ...
    for (idbkt = 0; idbkt < ndbkt; idbkt ++){
      ...
      while (img_i < ihi) {
        ...
        doublev4 dix = tranvec[itran][0] - i_crd_v4[0];
        doublev4 diy = tranvec[itran][1] - i_crd_v4[1];
        doublev4 diz = tranvec[itran][2] - i_crd_v4[2];

        for (img_j = 0; img_j < j_cnt_eval; img_j ++){
          ...
          if (has_lt_max_nb_cut) {
            ...
            if (has_lt_es_cut){
              ...
              doublev4 cgj_v4 = j_qterm[img_j];
              doublev4 cgi_cgj_v4 = simd_vselne(lt_max_nb_cut, i_qterm_v4 * cgj_v4, c0_v4);
            ...
            doublev4 ic_v4 = simd_vselne(lt_max_nb_cut, i_icd[jac], c0_v4);
